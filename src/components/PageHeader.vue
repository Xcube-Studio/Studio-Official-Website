  ...
  <header
    ...
    <div class="flex gap-4">
      <div class="flex gap-4 flex-none">
        <img class="border-1 border-neutral-600 rounded-sm w-8 h-8" :src="headerIcon" />
    ...
    <div class="flex justify-end flex-auto gap-2">
      ...
      <div class="gap-2 justify-end sm:flex hidden">
        <a href="https://github.com/Xcube-Studio/Studio-Official-Website/issues" id="report-button"
        ...
        <fluent-tooltip positioning="below" anchor="report-button" class="p-2 mt-2">
          报告问题
        </fluent-tooltip>
        <a id="code-button" href="https://github.com/Xcube-Studio/Studio-Official-Website"
          class="px-2 py-1.5 rounded-sm transition hover:bg-neutral-200 dark:hover:bg-neutral-700">
          <Icon icon="fluent:code-20-regular" class="w-5 h-5" />
        </a>
        <fluent-tooltip positioning="below" anchor="code-button" class="p-2 mt-2">
          网站仓库
        </fluent-tooltip>
      </div>
          ...
          <fluent-drawer-body class="dark:bg-neutral-900">
            <div class="p-1 flex bg-neutral-100 dark:bg-neutral-800">
              <div class="gap-2 py-3 px-3 flex justify-start">
                <a href="https://github.com/Xcube-Studio/Studio-Official-Website/issues" id="in-report-button"
                  class="px-2 py-1.5 rounded-sm transition hover:bg-neutral-200 dark:hover:bg-neutral-700">
                  <Icon icon="fluent:warning-20-filled" class="w-5 h-5" />
                </a>
                <fluent-tooltip positioning="below" anchor="in-report-button" class="p-2 mt-2">
                  报告问题
                </fluent-tooltip>
                <a href="https://github.com/Xcube-Studio/Studio-Official-Website" id="in-code-button"
                  class="px-2 py-1.5 rounded-sm transition hover:bg-neutral-200 dark:hover:bg-neutral-700">
                  <Icon icon="fluent:code-20-regular" class="w-5 h-5" />
                </a>
                <fluent-tooltip positioning="below" anchor="in-code-button" class="p-2 mt-2">
                  网站仓库
                </fluent-tooltip>
              </div>
              <div class="grow" />
